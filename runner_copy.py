...
def run_sort(in_file, out_file, type, cost, log_file, num):
    #for i in range(num):
    os.system(f'python3 /root/505p1/main.py {in_file} {out_file} {type} {cost} {num} >> {log_file}')
    last_line = ""
...
# get the directory
directory = f'/root/csc505-spring-2022/Project1/'
directory_list = os.listdir(directory)
out_file_base = "/root/505p1/output_copy/sorted_files/"
log_file_base = "/root/505p1/output_copy/OfficialRuns_copy/"
...
if sort_cost == "ALL" or sort_cost == "e":
    ...
    # run tim sort
    if sort_type == "ALL" or sort_type == "t":
        directory_sort("t", "e", "TimSortExpensive.log")
